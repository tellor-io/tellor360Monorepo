...
describe("Forking Tests - After Transition", function() {
 ...
 const TELLORX_ORACLE = "0x6732b279E7C975B39DfFedA7173e4E426aA9a40F"
  ...
  beforeEach("deploy and setup Tellor360", async function() {
    ...
    await oldGovernance.connect(bigWallet).vote(1, true, false)
    // await oldGovernance.connect(devWallet).vote(1, true, false)
    await h.advanceTime(86400*7)
    await oldGovernance.tallyVotes(1)
    await h.advanceTime(86400*2)
    await oldGovernance.executeVote(1)
    await tellor.init()
  });
